...
const HeroSection = () => {
  return (
    <div className="relative w-full h-[500px]">
      ...
      {/* Text Content */}
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center text-white px-6 space-y-7">
        <div>
          ...
          <p className="text-2xl mt-4">
            Explore the{" "}
            <span className="text-yellow-400 font-montserrat font-bold">
              vibrant events
            </span>{" "}
